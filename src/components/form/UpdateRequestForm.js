...
const UpdateRequestForm = ({ onClose, fetchRequests, currentItem }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await API.patch(`/requests/${currentItem._id}/status`, { status });
            ...
            <Card className="w-full max-w-2xl p-6 rounded-2xl shadow-2xl bg-white">
                ...
                <CardContent className="space-y-4 max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <InfoItem label="Urgence" value={currentItem.urgency === 'high' ? 'Haute' : currentItem.urgency === 'medium' ? 'Normale' : 'Faible'} />
                    </div>
